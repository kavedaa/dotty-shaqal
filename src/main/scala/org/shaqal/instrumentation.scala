...
trait Instrument[R] {
  ...
  trait Instance {
    ...
    def onParameterList(parameterList: Seq[SqlParameter[?]]): Unit = {}
...
object Instrument {
  given defaultInstrument as Instrument[DefaultInstrument.Result] = DefaultInstrument
}
...
object DefaultInstrument extends Instrument[DefaultInstrument.Result] {
  ...
  def createInstance = new Instance {
    ...
    override def onParameterList(parameterList: Seq[SqlParameter[?]]): Unit = { numParameterLists += 1 }
